...
class RechercheHistoryHeroServiceTest {
    ...
    void combat_history() {
        ...
        RechercheHistoryHeroCommand rechercheHistoryHeroCommand = new RechercheHistoryHeroCommand(heros);

        Mockito.when(persistanceAdapter.load_heros("123")).thenReturn(heros);
        List<Combat> heros_combat_history = rechercheHistoryHeroService.combat_history(rechercheHistoryHeroCommand);
